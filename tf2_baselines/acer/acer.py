...
from tf2_baselines.common import set_global_seeds
from tf2_baselines.common.policies import build_policy
from tf2_baselines.common.tf_util import get_session, save_variables, load_variables
from tf2_baselines.common.vec_env.vec_frame_stack import VecFrameStack

from tf2_baselines.a2c.utils import batch_to_seq, seq_to_batch
from tf2_baselines.a2c.utils import cat_entropy_softmax
from tf2_baselines.a2c.utils import Scheduler, find_trainable_variables
from tf2_baselines.a2c.utils import EpisodeStats
from tf2_baselines.a2c.utils import get_by_index, check_shape, avg_norm, gradient_add, q_explained_variance
from tf2_baselines.acer.buffer import Buffer
from tf2_baselines.acer.runner import Runner
...
def learn(network, env, seed=None, nsteps=20, total_timesteps=int(80e6), q_coef=0.5, ent_coef=0.01,
    ...
    env:                environment. Needs to be vectorized for parallel environment simulation.
                        The environments produced by gym.make can be wrapped using tf2_baselines.common.vec_env.DummyVecEnv class.
